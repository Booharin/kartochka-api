...
— {f"СЦЕНА: {card_prompt} — реализовать буквально и точно, убрать подставку и стандартную сцену если противоречат пожеланию" if card_prompt else "товар стоит на поверхности с тенью — не висит в воздухе"}
